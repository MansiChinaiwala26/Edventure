<%@ page import="java.io.*,java.sql.*,java.util.*,java.sql.Connection,java.sql.DriverManager,java.sql.Statement,java.sql.ResultSet,java.util.Scanner,java.sql.PreparedStatement" %>
        ...
        <nav class="navbar navbar-inverse" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.jsp"><img src="images/service/logo2.png" alt="logo"></a>
                </div>
