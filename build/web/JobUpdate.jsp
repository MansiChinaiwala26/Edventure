            ...
            <form id="main-contact-form123" class="contact-form" name="contact-form" 
                ...
                <div class="col-sm-5 col-sm-offset-1">
                    ...
                    <div class="form-group">
                        ...
                        <select name="sname" value="${cookie.sname.value}" class="form-control" required="required">
                    ...
                    <div class="form-group">
                        ...
                        <select name="cname" value="${cookie.cname.value}" class="form-control" required="required">
