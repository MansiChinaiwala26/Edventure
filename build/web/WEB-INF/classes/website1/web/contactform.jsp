<%-- 
    ...
    Created on : Oct 27, 2015, 12:01:48 PM
    Author     : pppppp
--%>
            ...
            <center>
                <form name="details" method="POST" action="">
                    <table cellpadding="5">
                        ...
                        <tr><td></td></tr>
                        <tr><td></td></tr>
                        <td height="24" colspan="4"><div align="center" class="style4"><font size="12">Contact Form</font></div></td>
                        <tr><td></td></tr>
                        <tr><td></td></tr>
                    </table>
                    <table border="2" size="10">
                        ...
                        <%            while (rs.next()) {
                                ...
                                String pname = rs.getString("Phone");
