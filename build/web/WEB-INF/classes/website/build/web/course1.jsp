        ...
        <div class="center">
         ...
         <center>   
            ...
            try {
                ...
                String query = "select * from degree_collges_courses where ID='"+request.getParameter("courseId") +"' ";
             // String query = "UPDATE student SET First_Name = 'Raj',Last_Name = 'Chinaiwala',Gender = 'Male',Date_Of_Birth = '1998/04/04',Address = 'Nanpura',City = 'Surat',State = 'Gujarat',Email = 'rajchinaiwala@gmail.com',Contact_no = '7864764856',Qulification = 'Diploma',User_Id = 'a',Password = 'a' WHERE ID=15"
                    ...
                    while (rs.next()) {
                            ...
                            String str6 = rs.getString("Branch Id");
                            String str4 = rs.getString("Branch Name");
                            String str5 = rs.getString("Seats");
                            
                            %>
                            
                            <tr>
                                <td cellpadding="10" ><%= str7 %></td>
                                <td><%= str6 %></td>
                                <td><%= str4 %></td>
                                <td><%= str5 %></td>
