   ...
   <section id="main-slider" class="no-margin">
        <div class="carousel slide">
            ...
            <div class="carousel-inner">
                ...
                <div class="item active" style="background-image: url(images/slider/dipcollege.jpg)">
                    <div class="container">
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1"><font color="#B40404">Diploma Colleges</font></h1>
                                    
                                    <a class="btn-slide animation animated-item-3" href="diplomacollege.jsp">Read More</a>
                                </div>
                            </div>
                ...
                <div class="item" style="background-image: url(images/slider/dcollege.jpg)">
                    <div class="container">
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1"><font color="#B40404">Degree Colleges</font></h1>
                                  <a class="btn-slide animation animated-item-3" href="degreecollege.jsp">Read More</a>
                                </div>
                            </div>
