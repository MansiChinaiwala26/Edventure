    ...
    <table cellpadding="5">
        ...
        <%
            ...
            try {
                ...
                String query = "UPDATE student SET LastName=?,FirstName=?,Gender=?,DateOfBirth=?,Address=?, State = ?,City = ?,  Email = ?, Contactno = ?, Qualification = ?,FavTeacher=?, User_Id = ?, Password = ? WHERE ID = ?";
