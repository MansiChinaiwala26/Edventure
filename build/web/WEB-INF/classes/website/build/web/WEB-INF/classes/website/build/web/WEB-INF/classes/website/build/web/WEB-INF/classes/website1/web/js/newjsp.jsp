<%-- 
    Document   : newjsp
    Created on : Apr 22, 2016, 11:22:08 PM
    Author     : Nidhi
--%>
                ...
                <form id="main-contact-form123" class="contact-form" name="contact-form" 
                    ...
                    <div class="col-sm-5 col-sm-offset-1">
                        ...
                        <div class="form-group">
                            ...
                            <input type="des" name="desname" class="form-control" required="required">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <input type="exps" name="ctname" class="form-control" required="required">
                            
                        </div>
                         <div class="form-group">
                            <label>Experience</label>
                            <select name="expyear" class="form-control" required="required">
                                    <option value ="1">1-2Years</option>
                                    <option value ="2">3-5Years</option>
                                    <option value ="3">5-7Years</option>
