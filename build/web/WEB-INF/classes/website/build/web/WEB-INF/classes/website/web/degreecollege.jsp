        ...
        <div class="center">
            <center>
                ...
                <table cellpadding="5">
                    ...
                    <tr><td></td></tr>
                    <tr><td></td></tr>
                    <td height="24" colspan="4"><div align="center" class="style4"><font size="12" color="black">Degree Colleges</font></div></td>
                    <tr><td></td></tr>
                    <tr><td></td></tr>
                    </tr>
                </table>
                ...
                <table border="2" size="10">
                    ...
                    <%
                        ...
                        try {
                            ...
                            String query = "select * from degree_self_finanace_colleges";
                            ...
                            while (rs.next()) {
                                ...
                                String str6 = rs.getString("CollegeName");
                                String str8 = rs.getString("Fees");
                    %>

                    <tr>
                        <td><a href="course1.jsp?courseId=<%=str7%>"><%= str7%></a></td>
                        <td><%= str6%></td>
                        <td><%= str8%></td>
