...
<br></br>
    <center>
        <%
            ...
            try {
                ...
                String query = "SELECT count(*) AS COUNT FROM `students_registration_info` WHERE User_Id='" + username + "'  AND Password ='" + oldpassword + "'";
    ...
    <%
        ...
        query = "UPDATE `edventure`.`students_registration_info` SET `Password` = '" + newpassword + "' WHERE User_Id='" + username + "'  AND `Password` = '" + oldpassword + "'";
