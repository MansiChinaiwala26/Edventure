...
<html>
    ...
    <section id="contact-page">
        <div class="container">
            <div class="center">        
                <form id="main-contact-form123" class="contact-form" name="testcal" 
                      method="post">
                    <center>
                        ...
                        <table cellpadding="5">
                            ...
                            <tr><td></td></tr>
                            <tr><td></td></tr>
                            <td height="24" colspan="4"><div align="center" class="style4"><font size="12">Test Result</font></div></td>
                            <tr><td></td></tr>
                            <tr><td></td></tr>
                        </table>
                        <%!int m;%>  <%  Connection con = null;

                            try {
                                Class.forName("com.mysql.jdbc.Driver");
                                con = DriverManager.getConnection("jdbc:mysql://localhost:3306/edventure", "root", "");
                                ...
                                while (rs.next()) {
                                    ...
                                    String chc = request.getParameter(id);
                                    if (answer.equalsIgnoreCase(chc)) {
                                        m++;
                                    }
