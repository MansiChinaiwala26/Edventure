    ...
    <center>
        ...
        <%
            ...
            try {
                ...
                String query = "INSERT INTO students_registration_info(LastName , FirstName , Gender , DateOfBirth , Address , State, City , Email , Contactno , Qualification ,FavTeacher, User_Id , Password)"
        ...
        <input type="hidden" name="state" value="<%=sname%>">
    </center>
    <% stm.close();
            cn.close();
        } catch (Exception e) {
