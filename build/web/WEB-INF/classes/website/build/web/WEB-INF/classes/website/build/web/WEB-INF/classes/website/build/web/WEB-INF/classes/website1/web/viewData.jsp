<%-- 
    Document   : viewData
    Created on : Oct 15, 2015, 8:21:20 PM
    Author     : Admin
--%>
            ...
            <center>
                <form name="details" method="POST" action="">
                    <table cellpadding="5">
                        ...
                        <tr><td></td></tr>
                        <tr><td></td></tr>
                        <td height="24" colspan="4"><div align="center" class="style4"><font size="12">Registered Form</font></div></td>
                        <tr><td></td></tr>
                        <tr><td></td></tr>
                    </table>
                    <table border="2" size="10">
                        ...
                        <%
                            ...
                            try {
                                ...
                                String query = "select * from students_registration_info";
                        ...
                        <%            while (rs.next()) {
                                ...
                                String bdate = rs.getString("DateOfBirth");
                                String add = rs.getString("Address");
                                String sname = rs.getString("State");
                                String cname = rs.getString("City");
                                String ename = rs.getString("Email");
                                String qname = rs.getString("Qualification");
                                String fav = rs.getString("FavTeacher");
