    ...
    <table cellpadding="5">
        ...
        <%
            ...
            try {
                ...
                String ID = null;
                String q = "SELECT * FROM students_registration_info";
                ...
                String query = "UPDATE students_registration_info SET LastName=?,FirstName=?,Gender=?,DateOfBirth=?,Address=?, State = ?,City = ?,  Email = ?, Contactno = ?, Qualification = ?,FavTeacher=?, User_Id = ?, Password = ? WHERE ID = ?";
                ...
                st.setString(5, request.getParameter("add"));
                st.setString(7, request.getParameter("sname"));
                st.setString(6, request.getParameter("cname"));
                
                st.setString(8, request.getParameter("ename"));
                st.setString(9, request.getParameter("ctname"));
                st.setString(10, request.getParameter("qname"));
                st.setString(11, request.getParameter("fav"));
                st.setString(12, request.getParameter("uname"));
                st.setString(13, request.getParameter("pname"));
