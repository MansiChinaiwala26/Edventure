    ...
    <section id="contact-page">
        <div class="container">
            <div class="center">        
                ...
                <br>
                <h2>REGISTRATION</h2>
                <p class="lead">Register to EDventure.</p>
            </div> 
            <div class="row contact-wrap"> 
                <div class="status alert alert-success" style="display: none"></div>
                <form id="main-contact-form123" class="contact-form" name="form" 
                      method="post" action="main.jsp">
                    <div class="col-sm-5 col-sm-offset-1">
                        ...
                        <div class="form-group">
                            <label>Gender  </label>
                            <br> <label>Female</label> <input type="radio" name="gender" value="Female" required="required" > <label>Male</label> <input type="radio" name="gender" value="Male" required="required">
                        </div>
                        <div class="form-group">
                            <label>Date of Birth  </label>
                            <input type="date" name="bdate" class="form-control" placeholder="YYYY/MM/DD" required="required">
                        </div>
                        <div class="form-group">
                            <label>Address *</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="qname" class="form-control" required="required">
                        </div>
                        <div class="form-group">
                            <label>User Id </label>
