    ...
    <center>
        ...
        <%
            ...
            try {
                ...
                String query = "SELECT count(*) AS COUNT FROM `student` WHERE  Email='" + registeredEmail + "'AND FavTeacher='" + registeredYourFavouriteTeacher + "'";
        ...
        <%
                ...
                query = "UPDATE `edventure`.`student` SET `Password` = '" + password + "' WHERE  FavTeacher = '" + registeredYourFavouriteTeacher + "' AND Email='" + registeredEmail + "'";
