<%-- 
    Document   : i1
    Created on : Oct 21, 2015, 2:57:30 AM
    Author     : pppppp
--%>

<%-- 
    Document   : index
    Created on : Sep 30, 2015, 3:01:01 AM
    Author     : pppppp
--%>
                        ...
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">Made by M2N</h1>
                                    <h2 class="animation animated-item-2">Educational website</h2>
                ...
                <div class="item" style="background-image: url(images/slider/bg2.jpg)">
                    <div class="container">
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">EDventure</h1>
                                    <h2 class="animation animated-item-2">Edventure is about bringing education to people instead of bringing people to education...</h2>
                                    <a class="btn-slide animation animated-item-3" href="#">Read More</a>
                                </div>
                            </div>
                ...
                <div class="item" style="background-image: url(images/slider/bg3.jpg)">
                    <div class="container">
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">Goals</h1>
                                    <h2 class="animation animated-item-2"> EDventure Provides.....</h2>
                                     <h2 class="animation animated-item-2"> Education guidance,Finding the colleges, job opportunities Ease associations efforts</h2>
                ...
                <div class="features">
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                            ...
                            <h2>Beneficial for job seekers</h2>
