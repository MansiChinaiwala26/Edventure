...
<br></br>
    <center>
        <%
            ...
            try {
                ...
                String query = "SELECT count(*) AS COUNT FROM `student` WHERE User_Id='" + username + "'  AND Password ='" + oldpassword + "'";
                ...
                if (count == 0) {
                    out.println("\n Invalid Username or Old Password<br/>");
                    out.println("Please Re-enter");
        %>
    </center>
    <center>
        <form name="details" method="POST" action="processChange.jsp">
            <table cellpadding="5">
                <tr  wdth ="100%">
                <tr><td></td></tr>
                <tr><td></td></tr>
    ...
    <%
        ...
        query = "UPDATE `edventure`.`student` SET `Password` = '" + newpassword + "' WHERE User_Id='" + username + "'  AND `Password` = '" + oldpassword + "'";
        st.executeUpdate(query);
        //UPDATE `edventure`.`login` SET `password` = 'nidhi1' WHERE `login`.`ID` = 1;
        
        //query = "UPDATE `edventure`.`login` SET `Password` = '" + newpassword + "' WHERE User_Id = '" + username + "' AND `Password` = '" + oldpassword + "'";
        //st.executeUpdate(query);
  
        out.print("Password updated try this :----> " + newpassword+"\n");
