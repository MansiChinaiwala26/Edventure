...
<html lang="en">
    ...
    <center>
        <form name="details" method="POST" action="companycheck.jsp">
            <table cellpadding="5">
                <tr  wdth ="100%">
                        <tr><td></td></tr>
                        <tr><td></td></tr>
            ...
            <table>
                    <tr>
                        <th>UserName</th>
                        <td><input type="text" name="usname" required="required"></td>
                    </tr>
                    <tr>
                        <th> Password </th>
                        <td><input type="password" name="psname" required="required"></td>
                    </tr>
                    <tr>
