...
<html lang="en">
    ...
    <body class="homepage">
        ...
        <br></br>
    <center>
        <%! String registeredEmail, registeredYourFavouriteTeacher;%>
        <%
            registeredEmail = request.getParameter("ename").toString().trim();


            registeredYourFavouriteTeacher = request.getParameter("fav").toString().trim();
            ...
            try {
                ...
                String query = "SELECT count(*) AS COUNT FROM `students_registration_info` WHERE  Email='" + registeredEmail + "'AND FavTeacher='" + registeredYourFavouriteTeacher + "'";
        ...
        <center>
            <form name="details" method="POST" action="setnewPasswordAndMail.jsp">
                <table cellpadding="5">
                    <tr  wdth ="100%">
                    <tr><td></td></tr>
                    <tr><td></td></tr>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="fav" required="required"></td>
                    </tr>
        ...
        <%
                ...
                query = "UPDATE `edventure`.`students_registration_info` SET `Password` = '" + password + "' WHERE  FavTeacher = '" + registeredYourFavouriteTeacher + "' AND Email='" + registeredEmail + "'";
                ...
                out.println("Please Check Your Verification Code on Your Mail: "+registeredEmail+" <BR> <a href='userlogin.jsp'>Click Me</a>");
                String msg = "Hi!! Your Verification Code:  " + password+" Use this as your password to Login.";
