<%-- 
    Document   : check
    Created on : Oct 13, 2015, 7:44:03 AM
    Author     : pppppp
--%>
<%@page import="java.util.Calendar"%>
<%@page import="java.text.SimpleDateFormat"%>
<%@page import="java.text.DateFormat"%>
<%@ page import="java.io.*,java.sql.Connection,java.sql.DriverManager,java.sql.Statement,java.sql.ResultSet,java.util.Scanner,java.sql.PreparedStatement" %>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse navbar-right">
                        <ul class="nav navbar-nav">
                           ...
                           <li class="active"><a href="companylogin.jsp">Login</a></li>
                            </ul>
                    </div>
                </div><!--/.container-->
            </nav><!--/nav-->
       ...
       <section id="blog" class="container">
        <div class="center">
            ...
            try {
                ...
                String query = "select Companyname from companydisplay where User_Id=? and Password=?";
             ...
             // String query = "UPDATE student SET First_Name = 'Raj',Last_Name = 'Chinaiwala',Gender = 'Male',Date_Of_Birth = '1998/04/04',Address = 'Nanpura',City = 'Surat',State = 'Gujarat',Email = 'rajchinaiwala@gmail.com',Contact_no = '7864764856',Qulification = 'Diploma',User_Id = 'a',Password = 'a' WHERE ID=15"
                ps.setString(1, request.getParameter("usname"));
                ps.setString(2, request.getParameter("psname"));
                    ...
                    if (rs.next()) {
                       ...
                       out.println("Invalid Username or Password <a href='companylogin.jsp'>Try again</a>");
