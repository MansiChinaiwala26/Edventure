        ...
        <div class="center">
            <center>
                ...
                <table cellpadding="5">
                    ...
                    <tr><td></td></tr>
                    <tr><td></td></tr>
                    <td height="24" colspan="4"><div align="center" class="style4"><font size="12">Company Profile</font></div></td>
                    <tr><td></td></tr>
                    <tr><td></td></tr>
                    </tr>
                </table>
                ...
                <table border="2" size="10">
                    ...
                    <%
                        ...
                        try {
                            ...
                            String query = "select * from companydisplay";
                            ...
                            while (rs.next()) {
                                ...
                                String str6 = rs.getString("Companyname");
                                String str8 = rs.getString("Field");
                                String str9 = rs.getString("Address");
                                String str10 = rs.getString("State");
                                String str11 = rs.getString("City");
                                String str14 = rs.getString("Website");
                                String str12 = rs.getString("Email");
                                String str13 = rs.getString("Contactno");
