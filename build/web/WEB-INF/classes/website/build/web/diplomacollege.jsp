<%-- 
    Document   : diplomacollege
    Created on : Oct 7, 2015, 4:00:30 PM
    Author     : pppppp
--%>
        ...
        <div class="center">
            <center>
                ...
                <table cellpadding="5">
                    ...
                    <tr><td></td></tr>
                    <tr><td></td></tr>
                    <td height="24" colspan="4"><div align="center" class="style4"><font size="12"color="black">Diploma Colleges</font></div></td>
                    <tr><td></td></tr>
                    <tr><td></td></tr>
                    </tr>
                </table>
            ...
            <center>   
                <table border="2" size="10">
                    ...
                    <th><center>Colleges</center></th>
                    <th><center>SelfFinance</center></th>
                    <th><center>HostelFacilities</center></th>
                    ...
                    <%
                        ...
                        try {
                            ...
                            String query = "select * from diploma_self_finanace_colleges";
                            ...
                            while (rs.next()) {
                                ...
                                String str = rs.getString("CollegeName");
                                String str4 = rs.getString("SelfFinance");
                                String str5 = rs.getString("HostelFacilities");
                                String str3 = rs.getString("Fees");

                    %>

                    <tr>
                        <td><a href="course2.jsp?courseId=<%=str1%>" ><%= str1%></a></td>
                        <td><%= str%></td>
                        <td><%= str4%></td>
                        <td><%= str5%></td>
                        <td><%= str3%></td> 
