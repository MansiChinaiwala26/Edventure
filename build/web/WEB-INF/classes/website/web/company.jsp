        ...
        <div class="container">
            ...
            <div class="row contact-wrap"> 
                ...
                <form id="main-contact-form123" class="contact-form" name="contact-form" 
                      method="post" action="companyprocess.jsp">
                    <div class="col-sm-5 col-sm-offset-1">
                        <div class="form-group">
                            <label>Company Name*</label>
                            <input type="text" name="coname" class="form-control"required="required">
                        </div>
                        <div class="form-group">
                            <label>Field*</label>
                            <input type="text" name="field" class="form-control"required="required">
                        </div>
                        <div class="form-group">
                            <label>Address *</label>
                            <input type="textbox" name="address" class="form-control" required="required">
                        </div>
                        ...
                        <div class="form-group">
                            <label>Website* </label>
                            <input type="text" name="emname" class="form-control" required="required">
                        </div>
                        <div class="form-group">
                            <label>Email* </label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="cnt" class="form-control" required="required">
                        </div>
                        <div class="form-group">
                            <label>Your Favourite Teacher* </label>
                            <input type="text" name="ftname" class="form-control" required="required" placeholder="Security Question">
                        </div>
                        <div class="form-group">
                            <label>User Id* </label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="psname" class="form-control" required="required">
