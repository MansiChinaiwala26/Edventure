...
<html>
    ...
    <center>
        <%
            ...
            Cookie emailName = new Cookie("emname",
        ...
        <%
            ...
            try {
                ...
                String query = "INSERT INTO company(Companyname,Address,City,State,Email,Contactno,YourFavouriteTeacher,`User Id`,Password)"
                        + " values ('" + coname + "','" + address + "','" + city + "','" + state + "','" + emname + "',"
    ...
    <center>
        ...
        <form name="details" method="POST" action="login.jsp">

            <input type="submit" value="Confirm" name="submit" onclick="SetCookie()" class="btn btn-primary btn-lg">
            <input type="submit" value="Edit" name="edit" formaction="companyupdate.jsp" onclick="SetCookie()" class="btn btn-primary btn-lg">
    <input type="hidden" name="IDX" value="<%=r%>">
    <input type="hidden" name="sname" value="<%=state%>">
